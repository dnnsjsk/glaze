...
Glaze is designed to work seamlessly with [GSAP](https://greensock.com/gsap/), a
powerful animation library. To use Glaze, you must include GSAP in your project.

### GSAP Licensing

GSAP is subject to its own licensing terms. Before incorporating GSAP with
Glaze, ensure you review and comply with these terms, available here:
